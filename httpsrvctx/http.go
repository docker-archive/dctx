...
func WithRequest(ctx dctx.Context, r *http.Request) dctx.Context {
...
// with it.
func GetRequest(ctx dctx.Context) (*http.Request, error) {
...
func GetRequestID(ctx dctx.Context) string {
	return dctx.GetStringValue(ctx, "http.request.id")
}

// WithResponseWriter returns a new context and response writer that makes
// interesting response statistics available within the context.
func WithResponseWriter(ctx dctx.Context, w http.ResponseWriter) (dctx.Context, http.ResponseWriter) {
...
func GetResponseWriter(ctx dctx.Context) (http.ResponseWriter, error) {
